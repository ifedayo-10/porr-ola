...
export default function Cooperation() {
  ...
  const items = [
    { title: t("independent_title"), desc: t("independent_desc"), icon: icons[0] },
    { title: t("consortium_title"), desc: t("consortium_desc"), icon: icons[1] },
    { title: t("sub_title"), desc: t("sub_desc"), icon: icons[2] },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {items.map((item, i) => (
            ...
            >
              <div className="w-12 h-12 bg-[#0a1628] text-amber-400 rounded-xl flex items-center justify-center mb-6">
                {item.icon}
              </div>
